...
class SubmitForm(FlaskForm):
    ...
    category = RadioField('category', 
        choices=[('numbers', 'numbers'), ('seasons', 'seasons'), ('pets', 'pets'),('months', 'months'), ('time', 'time'),('transportation', 'transportation'), ('colors', 'colors'), ('money', 'money')], validators = [DataRequired()])
